...
ENV ARTIFACT_API_KEY=$ARTIFACT_API_KEY
ENV ARTIFACT_API_SECRET=$ARTIFACT_API_SECRET
ENV ARTIFACT_URI=$ARTIFACT_URI
ENV CONGEAL_USERNAME=$CONGEAL_USERNAME
...
# Pass the environment variables to the runtime container
ENV ARTIFACT_API_KEY=$ARTIFACT_API_KEY
ENV ARTIFACT_API_SECRET=$ARTIFACT_API_SECRET
ENV ARTIFACT_URI=$ARTIFACT_URI
ENV CONGEAL_USERNAME=$CONGEAL_USERNAME
